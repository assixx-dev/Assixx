...
export const load: PageServerLoad = async ({ cookies, fetch, parent, url }) => {
  ...
  // UX default: show only ACTIVE employees on bare URL (`/manage-employees`).
  // Was `'all'` until 2026-05; product feedback — admins overwhelmingly want
  // the live workforce first, archived/inactive only on explicit toggle.
